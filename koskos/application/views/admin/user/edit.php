...
echo form_open(base_url('admin/user/edit/'.$user->id_user),' class="form-horizontal"');
 ...
 <div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="username" class="form-control" placeholder="Username pengguna" value=
 ...
 <div class="form-group">
  ...
  <div class="col-md-5">
    <input type="password" name="password" class="form-control" placeholder="Silahkan Masukkan Password Anda" value=
    "" required>
  </div>
</div>
